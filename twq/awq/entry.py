...
parser.add_argument(
    "--target_neurons", type=str, default=None, help="Path to neuron indeces to target"
)
...
def build_model_and_enc(model_path):
    ...
    if args.load_quant:  # directly load quantized weights
        ...
        if args.run_awq:
            ...
            language_neurons = torch.load(args.target_neurons)
            ...
            awq_results = run_awq(
                ...
                n_samples=128,
                seqlen=512,
                target_neurons=language_neurons,
            )
            if args.dump_awq:
